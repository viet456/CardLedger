...
export function ClientCachedDetailsFallback({ cardId }: { cardId: string }) {
    ...
    const rarityName = card.r !== null ? rarities[card.r] : null;
        ...
        <div className='flex flex-col gap-8 md:col-span-2'>
            ...
            <section className='rounded-lg border bg-card p-4 shadow-sm'>
                ...
                <p className="text-xs text-muted-foreground mt-4 text-center">
                    Prices are currently showing your local cache, last updated on <span className="font-semibold">{syncDate}</span>.
                </p>
            </section>
